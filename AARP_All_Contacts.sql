select
        ...
        max(case when sdr_cust_atributes_key = 51 then atribute_value else null end) as Postal_Code,  --New Attribute as of 2021-10-07--
        max(case when sdr_cust_atributes_key = 52 then atribute_value else null end) as Address_2,    --New Attribute as of 2021-10-22--
        max(case when sdr_cust_atributes_key = 53 then atribute_value else null end) as Campaign_Name --New Attribute as of 2021-10-22--
